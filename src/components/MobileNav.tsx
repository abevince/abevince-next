...
const MobileNav = () => (
  <Menu as="div" className="relative inline-block text-left md:hidden">
    ...
    >
      <Menu.Items
        as="section"
        className="origin-top-right absolute right-0 mt-2 w-56 rounded-md shadow-sm shadow-neutral-700 backdrop-blur-sm bg-zinc-600/30 border-2 border-neutral-700 border-opacity-5 focus:outline-none"
      >
        <div className="py-1">
          <Menu.Item>
